        ...
        Self {
            ...
            planets: vec![
                ...
                PlanetAssets::new([
                    ...
                    server.load("images/planet-moon-3.png"),
                    server.load("images/planet-moon-4.png"),
                    server.load("images/planet-moon-5.png"),
                    server.load("images/planet-moon-6.png"),
                    server.load("images/planet-moon-7.png"),
                ]),
            ],
        }
    }
